...
const Footer = () => {
  ...
  return (
    <div className="bg-cranberry-800 text-neutral-content bg-opacity-30 backdrop-blur-lg backdrop-filter shadow-sm shadow-sinbad-200">

   <footer className="container mx-auto footer items-center px-10 py-5">
